        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body row switch-showcase height-equal">
                    <h2 class="fs-5 mb-4">Daftar Asset</h2>
                    <div class="mb-3">
...
<div id="modalBase" class="d-none">
    ...
    <button type="button" data-bs-toggle="modal" id="btnOpenModal" data-bs-target="#insertAsset" class="btn btn-primary">Insert</button>
</div>
