                ...
                <div class="row row-cols-1 row-cols-lg-2">
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kode') is-invalid @enderror" name="kode" id="kode" value="{{ old('kode') ? old('kode') : $aset->kode }}" placeholder="Masukkan kode aset">
                            @error('kode')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" id="nama" value="{{ old('nama') ? old('nama') : $aset->nama }}" placeholder="Masukkan nama aset">
                            @error('nama')
                            <span class="text-danger d-block">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('status') is-invalid @enderror" name="status" id="status">
                                ...
                                <option value="tidak aktif" {{ old('status', $aset->status) == 'tidak aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                            </select>
                            @error('status')
                            <span class="text-danger d-block">{{ $message }}</span>
                            @enderror
