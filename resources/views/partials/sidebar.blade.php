        ...
        <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list mb-2" id="menu_aset"><a class="sidebar-link sidebar-title" href="#"><i data-feather="truck"></i><span>Asset Management</span></a>
                        <ul class="sidebar-submenu">
                    ...
                    <li class="sidebar-list mb-2" id="menu-gate"><a class="sidebar-link sidebar-title" href="#"><i data-feather="command"></i><span>Gate Access</span></a>
                        <ul class="sidebar-submenu">
                    ...
                    <li class="sidebar-list mb-2" id="menu-guard"><a class="sidebar-link sidebar-title" href="#"><i data-feather="layers"></i><span>Guard Management</span></a>
                        <ul class="sidebar-submenu">
